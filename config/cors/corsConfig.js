...
const corsOptions = {
    origin: (origin, callback) => {
        const allowedOrigins = ['http://localhost:3000','http://localhost:5500','https://azi-management-system.vercel.app','http://192.168.1.3:3000']; // Các client (domain) được phép truy cập
